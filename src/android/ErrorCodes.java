...
public class ErrorCodes {
    ...
    public static String getError(int codeError, int internalError) {
        switch (codeError) {
            case MORPHOERR_SVC_LOST_DEVICE /*-110*/:
            ...
            case MORPHOERR_CANT_GRAN_PERMISSION_USB /*-99*/:
            ...
            case 0:
                return "No error.";
            default:
                return String.format("Unknown error %d, Internal Error = %d", new Object[]{Integer.valueOf(codeError), Integer.valueOf(internalError)});
        }
    }

    public static Boolean IntegrerInitializationValueOf(Integer integer) {
        if (System.identityHashCode(integer) != System.identityHashCode(Integer.valueOf(integer.intValue()))) {
            return Boolean.valueOf(false);
        }
        Log.e("MorphoSmart SDK", "Error, initialize Integer with new Integer(0)");
        return Boolean.valueOf(true);
    }

    public static Boolean LongInitializationValueOf(Long longValue) {
        if (System.identityHashCode(longValue) != System.identityHashCode(Long.valueOf(longValue.longValue()))) {
            return Boolean.valueOf(false);
        }
        Log.e("MorphoSmart SDK", "Error, initialize Long with new Long(0)");
        return Boolean.valueOf(true);
    }
}
