...
public class USBDeviceAttributes implements Parcelable {
    public static Creator<USBDeviceAttributes> CREATOR = new C00321();
    ...
    /* renamed from: com.morpho.android.usb.USBDeviceAttributes$1 */
    class C00321 implements Creator<USBDeviceAttributes> {
        C00321() {
        }
